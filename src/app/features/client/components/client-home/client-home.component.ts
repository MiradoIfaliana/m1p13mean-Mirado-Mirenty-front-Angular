...
/*promotions = signal([
  ...
  boutiques= computed(()=>this.clientStore.boutiques());
  loadingBoutiques= computed(()=>this.clientStore.loadingBoutiques());
  // signal(
  //   {
  //     data: [
  //       {
  ...
  promotions =  computed(()=>this.clientStore.promotions());
  loadingPromotions =  computed(()=>this.clientStore.loadingPromotions());
//   signal(
//     {
//   data: [
//     {
...
//   );
  ...
  annonces =  computed(()=>this.clientStore.annonces());
  loadingAnnonces =  computed(()=>this.clientStore.loadingAnnonces());
  // signal([
  ...
  categories= computed(()=>this.clientStore.categories());
  loadingCategories= computed(()=>this.clientStore.loadingCategories());
  // signal( [
  ...
  ngOnInit(): void {
      ...
      this.clientStore.loadPromotions();
      this.clientStore.loadAnnonces();
      this.clientStore.loadCategories();
  }
  ...
  toPromotionDetail(id: string) {
    this.router.navigate(['client/promotions', id]);
  }

  toBoutiqueDetail(id: string) {
